...
hong = "\033[1;95m"
# Đánh dấu bản quyền
TUNG_PC= "\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  "
TUNG_DARK= "\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  "
##### Cài Thư Viện #####
...
def main():
	...
	while True:
		if os.path.exists('configtds.txt'):
			...
			data = tds.main()
			try:
				print(f'{TUNG_PC}{luc}Nhập {vang}[{trang}1{vang}] {luc}Giữ Lại Tài Khoản '+vang+ data['user'] )
				print(f'{TUNG_PC}{luc}Nhập {vang}[{trang}2{vang}] {luc}Nhập Access_Token TDS Mới')
				chon = input(f'{TUNG_PC}{luc}Nhập {trang}===>: {vang}')
				if chon == '2':
...
#while True:
	...
	banner()
	print(f'{TUNG_PC}{luc}Tên Tài Khoản: {vang}{user} ')
	print(f'{TUNG_PC}{luc}Xu Hiện Tại: {vang}{xu}')
	print(f'{TUNG_PC}{luc}Xu Bị Phạt: {vang}{xudie} ')
	while True:
		ntool=0
		bongoc(14)
		print(f'{TUNG_PC}{luc}Nhập {red}[{vang}1{red}] {luc}Để Chạy Nhiệm Vụ Tim')
		print(f'{TUNG_PC}{luc}Nhập {red}[{vang}2{red}] {luc}Để Chạy Nhiệm Vụ Follow')
		print(f'{TUNG_PC}{luc}Nhập {red}[{vang}3{red}] {luc}Để Chạy Nhiệm Vụ Follow Tiktok Now')
		nhiem_vu=input(f'{TUNG_PC}{luc}Nhập Số Để Chạy Nhiệm Vụ: {vang}')
		dl = int(input(f'{TUNG_PC}{luc}Nhập Delay: {vang}'))
		while True:
			if ntool == 2:
				break
			ntool = 0
			bongoc(14)
			nv_nhan=int(input(f'{TUNG_PC}{luc}Sau Bao Nhiêu Nhiệm Vụ Thì Nhận Xu: {vang}'))
			if nv_nhan < 8:
			...
			if nv_nhan > 15:
				...
				continue
			user_cau_hinh=input(f'{TUNG_PC}{luc}Nhập User Name Tik Tok Cần Cấu Hình: {vang}')
